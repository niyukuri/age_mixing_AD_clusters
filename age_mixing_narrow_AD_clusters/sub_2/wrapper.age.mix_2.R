...
wrapper.age.mix <- function(inputvector=inputvector){
  ...
  work.dir <- "/home/dniyukuri/lustre/age_mixing_narrow_AD_2" # on CHPC
  ...
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_2/age.mix.MCAR.MAR.comput.R")
...
write.csv(narrow.AD.age.mix, file = "Results.mcarmar.narrow.AD_2_56_222.csv")
