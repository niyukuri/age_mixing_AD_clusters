...
age.mix.MCAR.MAR.comput <- function(inputvector=inputvector){
  ...
  # source("/home/niyukuri/Dropbox/25.10.2018.age.mix2/age_mixing_narrow_AD_clusters/needed.functions.RSimpactHelp.R")
  # source("/home/niyukuri/Dropbox/25.10.2018.age.mix2/age_mixing_narrow_AD_clusters/advanced.transmission.network.builder.R")
  # source("/home/niyukuri/Dropbox/25.10.2018.age.mix2/age_mixing_narrow_AD_clusters/age.mixing.MCAR.fun.R")
  # source("/home/niyukuri/Dropbox/25.10.2018.age.mix2/age_mixing_narrow_AD_clusters/age.mixing.MAR.fun.R")
  
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_clusters/needed.functions.RSimpactHelp.R")
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_clusters/advanced.transmission.network.builder.R")
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_clusters/age.mixing.MCAR.fun.R")
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_clusters/age.mixing.MAR.fun.R")
  
  # work.dir <- "/home/niyukuri/Dropbox/25.10.2018.age.mix2/age_mixing_narrow_AD_clusters/" # on PC
  
  work.dir <- "/home/dniyukuri/lustre/age_mixing_narrow_AD_clusters" # on PCHPC
  ...
  if (length(results) == 0){
    ...
    if (as.numeric(results["eventsexecuted"]) >= (as.numeric(cfg.list["population.maxevents"]) - 1)){
      ...
      if(length(big.index) >= 1){ 
        ...
        results.outputvector <- c(results.summary.epidemic.rels.df, cov.100.stats,
        ...
        results.outputvector <- rep(NA, 10366) # 19 + 51 + 198*13*4
