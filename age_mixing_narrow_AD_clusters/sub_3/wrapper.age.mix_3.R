...
wrapper.age.mix <- function(inputvector=inputvector){
  ...
  work.dir <- "/home/dniyukuri/lustre/age_mixing_narrow_AD_3" # on CHPC
  ...
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_3/age.mix.MCAR.MAR.comput.R")
...
write.csv(narrow.AD.age.mix, file = "Results.mcarmar.narrow.AD_3_56_333.csv")
