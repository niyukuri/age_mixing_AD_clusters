...
wrapper.age.mix <- function(inputvector=inputvector){
  ...
  work.dir <- "/home/dniyukuri/lustre/age_mixing_narrow_AD_4" # on CHPC
  ...
  source("/home/dniyukuri/lustre/age_mixing_narrow_AD_4/age.mix.MCAR.MAR.comput.R")
...
write.csv(narrow.AD.age.mix, file = "Results.mcarmar.narrow.AD_4_56_444.csv")
