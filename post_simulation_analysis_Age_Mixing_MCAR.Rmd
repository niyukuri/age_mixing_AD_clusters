...
Inferring age mixing from transmission clusters in a scenario of data missingess, where an individual is missing randomly in the sample without any explanation (or cause).
...
The table shows true age mixing patterns (in relationships) of selected indiviuals (MCAR) in difference sequence coverage scenarios. These selecetd individuals are HIV positive, the measurement below assess their age mixing pattenrs within their sexual partnerships.
...
We can see that the average age difference from infected individuals in their partnership is not far from the mean of preferred age differences distribution for men/women which was 10, the difference between the two is less than 1. Same fact is observed from standard deviation of age difference in partnership of infected individuals and standard deviation of preferred age differences distribution for men, which was 5 ; the difference between the two is slightly greater than 1.

#### Difference between true values of age mixing at population level and sampling scenarios in MCAR
...
The error for WSD.male and SDAD.male parameters varies between 0 and 0.05 (WSD.male being on top), AAD.male turns around 0.1, BSD.male and slope.male varies between 0.2 and 0.25 (slope being on top), and the intercept.male varies between 0.4 and 0.45. All the variations of these measurements across different sequence scenarios don't show any dramatic change, they are pseudo-stationary. 
...
As the sequence coverage increase the number of pairings becomes close to the true values at 100% coverage.
...
plot.MRE.error.infer.clust.cov.100.prop.men.15.25.F.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.15.25.F.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men and women 15 - 25 - MCAR") +
...
plot.MRE.error.infer.clust.cov.100.prop.men.15.25.F.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.15.25.F.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 15 - 25 and women 25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.15.25.F.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.15.25.F.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 15 - 25 and women 40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.15.25.M.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.15.25.M.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women and men  in 15 - 25 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.15.25.M.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.15.25.M.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 15 - 25 and men  25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.15.25.M.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.15.25.M.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 15 - 25 and men  40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.25.40.F.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.25.40.F.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men and women in 25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.25.40.F.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.25.40.F.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 25 - 40 and women 15 - 25 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.25.40.F.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.25.40.F.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 25 - 40 and women 40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.25.40.M.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.25.40.M.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women and men in 25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.25.40.M.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.25.40.M.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 25 - 40 and men 15 - 25 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.25.40.M.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.25.40.M.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 25 - 40 and men 40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.40.50.F.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.40.50.F.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men and women in  40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.40.50.F.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.40.50.F.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 40 - 50 and women 15 - 25 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.men.40.50.F.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.men.40.50.F.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for men 40 - 50 and women 25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.40.50.M.40.50 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.40.50.M.40.50, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women and men  in 40 - 50 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.40.50.M.15.25 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.40.50.M.15.25, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 40 - 50 and men 15 - 25 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
...
plot.MRE.error.infer.clust.cov.100.prop.women.40.50.M.25.40 <- ggplot(MRE.error.infer.clust.cov.100.prop.women.40.50.M.25.40, aes(x = x, y = F)) +
  geom_point(size = 4) +
  ggtitle("Average relative error of the proportion for women 40 - 50 and men 25 - 40 - MCAR") +
  xlab("Sequence coverage scenarios") + ylab("Error value")
